...
function App() {
  ...
  return (
    ...
    <div className='projects' ref={pRef}>
      ...
      text={["시멘틱 마크업","웹 표준 및 웹 접근성 고려","크로스 브라우징","반응형 웹사이트"]} />
      <Project project={"3 . PROJECT"} FaChevronRight={<FaChevronRight className='prev' onClick={ArrowRightClick} />} FaChevronLeft={<FaChevronLeft className='next' onClick={ArrowLeftClick}/>} imgSrc={'img/kakao.mp4'} imgAlt={"kakao앱"} title={"KAKAO TILK"} subTitle={"카카오톡앱"} language={"HTML5,CSS(scss),react"} GitHref={"https://github.com/rlatjsghd123/kakao _app"} URLHref={" https://rlatjsghd123.github.io/kakao_app/"}
